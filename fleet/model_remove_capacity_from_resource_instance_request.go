...
// checks if the RemoveCapacityFromResourceInstanceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveCapacityFromResourceInstanceRequest{}

// RemoveCapacityFromResourceInstanceRequest struct for RemoveCapacityFromResourceInstanceRequest
type RemoveCapacityFromResourceInstanceRequest struct {
...
type _RemoveCapacityFromResourceInstanceRequest RemoveCapacityFromResourceInstanceRequest
...
func NewRemoveCapacityFromResourceInstanceRequest(capacityToBeRemoved int64, id string, productTierKey string, resourceKey string, serviceAPIVersion string, serviceEnvironmentKey string, serviceKey string, serviceModelKey string, serviceProviderId string, token string) *RemoveCapacityFromResourceInstanceRequest {
	this := RemoveCapacityFromResourceInstanceRequest{}
...
func (o RemoveCapacityFromResourceInstanceRequest) MarshalJSON() ([]byte, error) {
...
func (o RemoveCapacityFromResourceInstanceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RemoveCapacityFromResourceInstanceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoveCapacityFromResourceInstanceRequest := _RemoveCapacityFromResourceInstanceRequest{}

	err = json.Unmarshal(data, &varRemoveCapacityFromResourceInstanceRequest)

	if err != nil {
		return err
	}

	*o = RemoveCapacityFromResourceInstanceRequest(varRemoveCapacityFromResourceInstanceRequest)
...
type NullableRemoveCapacityFromResourceInstanceRequest struct {
	value *RemoveCapacityFromResourceInstanceRequest
	isSet bool
}

func (v NullableRemoveCapacityFromResourceInstanceRequest) Get() *RemoveCapacityFromResourceInstanceRequest {
	return v.value
}

func (v *NullableRemoveCapacityFromResourceInstanceRequest) Set(val *RemoveCapacityFromResourceInstanceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoveCapacityFromResourceInstanceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoveCapacityFromResourceInstanceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoveCapacityFromResourceInstanceRequest(val *RemoveCapacityFromResourceInstanceRequest) *NullableRemoveCapacityFromResourceInstanceRequest {
	return &NullableRemoveCapacityFromResourceInstanceRequest{value: val, isSet: true}
}

func (v NullableRemoveCapacityFromResourceInstanceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoveCapacityFromResourceInstanceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
