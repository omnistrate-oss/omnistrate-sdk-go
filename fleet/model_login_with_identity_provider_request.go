...
// checks if the LoginWithIdentityProviderRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoginWithIdentityProviderRequest{}
...
type _LoginWithIdentityProviderRequest LoginWithIdentityProviderRequest
...
func (o LoginWithIdentityProviderRequest) MarshalJSON() ([]byte, error) {
...
func (o *LoginWithIdentityProviderRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varLoginWithIdentityProviderRequest := _LoginWithIdentityProviderRequest{}

	err = json.Unmarshal(data, &varLoginWithIdentityProviderRequest)

	if err != nil {
		return err
	}

	*o = LoginWithIdentityProviderRequest(varLoginWithIdentityProviderRequest)
...
type NullableLoginWithIdentityProviderRequest struct {
	value *LoginWithIdentityProviderRequest
	isSet bool
}

func (v NullableLoginWithIdentityProviderRequest) Get() *LoginWithIdentityProviderRequest {
	return v.value
}

func (v *NullableLoginWithIdentityProviderRequest) Set(val *LoginWithIdentityProviderRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLoginWithIdentityProviderRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLoginWithIdentityProviderRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoginWithIdentityProviderRequest(val *LoginWithIdentityProviderRequest) *NullableLoginWithIdentityProviderRequest {
	return &NullableLoginWithIdentityProviderRequest{value: val, isSet: true}
}

func (v NullableLoginWithIdentityProviderRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoginWithIdentityProviderRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
