...
func main() {
	id := "Dolorem maxime voluptas rerum delectus in." // string | The unique id per producer.
	body := "Voluptates maiores eaque non molestiae repellat." // string | The event data
