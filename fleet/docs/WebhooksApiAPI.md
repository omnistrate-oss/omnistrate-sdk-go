...
func main() {
	id := "Quos voluptatem laboriosam repellat." // string | The unique id per producer.
	body := "Sed incidunt non voluptates ratione facere accusantium." // string | The event data
