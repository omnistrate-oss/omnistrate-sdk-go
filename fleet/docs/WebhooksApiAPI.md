...
func main() {
	id := "Temporibus mollitia quo omnis illo." // string | The unique id per producer.
	body := "Voluptatibus cupiditate iure recusandae quis ducimus." // string | The event data
