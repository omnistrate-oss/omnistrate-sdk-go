...
func main() {
	id := "Blanditiis aspernatur dicta qui esse officia." // string | The unique id per producer.
	body := "Maxime et ut voluptatum voluptatem quod molestiae." // string | The event data
