...
func main() {
	id := "Reprehenderit earum aut temporibus." // string | The unique id per producer.
	body := "Itaque laudantium voluptatem repellendus consequatur nostrum inventore." // string | The event data
