...
[**InventoryApiDeleteResourceInstanceSnapshot**](InventoryApiAPI.md#InventoryApiDeleteResourceInstanceSnapshot) | **Delete** /2022-09-01-00/fleet/service/{serviceId}/environment/{environmentId}/snapshot/{snapshotId} | DeleteResourceInstanceSnapshot inventory-api
...
[**InventoryApiListAllSnapshotsInHostCluster**](InventoryApiAPI.md#InventoryApiListAllSnapshotsInHostCluster) | **Get** /2022-09-01-00/fleet/host-clusters/{hostClusterId}/snapshots | ListAllSnapshotsInHostCluster inventory-api
...
[**InventoryApiListInstanceUpgradeHistory**](InventoryApiAPI.md#InventoryApiListInstanceUpgradeHistory) | **Get** /2022-09-01-00/fleet/service/{serviceId}/environment/{environmentId}/instance/{instanceId}/upgrade-history | ListInstanceUpgradeHistory inventory-api
...
[**InventoryApiUpdateResourceInstanceMetadata**](InventoryApiAPI.md#InventoryApiUpdateResourceInstanceMetadata) | **Patch** /2022-09-01-00/fleet/service/{serviceId}/environment/{environmentId}/instance/{instanceId}/metadata | UpdateResourceInstanceMetadata inventory-api
...
func main() {
	...
	fleetAddCapacityToResourceInstanceRequest2 := *openapiclient.NewFleetAddCapacityToResourceInstanceRequest2(int64(3), "Suscipit quisquam.") // FleetAddCapacityToResourceInstanceRequest2 | 
...
## InventoryApiBulkImportAccountConfigCloudNativeNetworks

> FleetListAccountConfigCloudNativeNetworksResult InventoryApiBulkImportAccountConfigCloudNativeNetworks(ctx, id).FleetBulkImportAccountConfigCloudNativeNetworksRequest2(fleetBulkImportAccountConfigCloudNativeNetworksRequest2).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InventoryApiAPI.InventoryApiBulkImportAccountConfigCloudNativeNetworks(context.Background(), id).FleetBulkImportAccountConfigCloudNativeNetworksRequest2(fleetBulkImportAccountConfigCloudNativeNetworksRequest2).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InventoryApiAPI.InventoryApiBulkImportAccountConfigCloudNativeNetworks``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `InventoryApiBulkImportAccountConfigCloudNativeNetworks`: FleetListAccountConfigCloudNativeNetworksResult
	fmt.Fprintf(os.Stdout, "Response from `InventoryApiAPI.InventoryApiBulkImportAccountConfigCloudNativeNetworks`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiInventoryApiBulkImportAccountConfigCloudNativeNetworksRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **fleetBulkImportAccountConfigCloudNativeNetworksRequest2** | [**FleetBulkImportAccountConfigCloudNativeNetworksRequest2**](FleetBulkImportAccountConfigCloudNativeNetworksRequest2.md) |  | 

### Return type

[**FleetListAccountConfigCloudNativeNetworksResult**](FleetListAccountConfigCloudNativeNetworksResult.md)
...
## InventoryApiCopyResourceInstanceSnapshot

> FleetCopyResourceInstanceSnapshotResult InventoryApiCopyResourceInstanceSnapshot(ctx, serviceId, environmentId, instanceId).FleetCopyResourceInstanceSnapshotRequest2(fleetCopyResourceInstanceSnapshotRequest2).Execute()
...
func main() {
	...
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	instanceId := "instance-12345678" // string | The resource instance ID.
	fleetCopyResourceInstanceSnapshotRequest2 := *openapiclient.NewFleetCopyResourceInstanceSnapshotRequest2("us-west-2") // FleetCopyResourceInstanceSnapshotRequest2 | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InventoryApiAPI.InventoryApiCopyResourceInstanceSnapshot(context.Background(), serviceId, environmentId, instanceId).FleetCopyResourceInstanceSnapshotRequest2(fleetCopyResourceInstanceSnapshotRequest2).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InventoryApiAPI.InventoryApiCopyResourceInstanceSnapshot``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `InventoryApiCopyResourceInstanceSnapshot`: FleetCopyResourceInstanceSnapshotResult
	fmt.Fprintf(os.Stdout, "Response from `InventoryApiAPI.InventoryApiCopyResourceInstanceSnapshot`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiInventoryApiCopyResourceInstanceSnapshotRequest struct via the builder pattern
 ...
 **fleetCopyResourceInstanceSnapshotRequest2** | [**FleetCopyResourceInstanceSnapshotRequest2**](FleetCopyResourceInstanceSnapshotRequest2.md) |  | 

### Return type

[**FleetCopyResourceInstanceSnapshotResult**](FleetCopyResourceInstanceSnapshotResult.md)
...
func main() {
	fleetCreateServicesOrchestrationRequest2 := *openapiclient.NewFleetCreateServicesOrchestrationRequest2("Cupiditate officia nostrum dolor.") // FleetCreateServicesOrchestrationRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | The service ID this workflow belongs to.
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	fleetCreateSubscriptionOnBehalfOfCustomerRequest2 := *openapiclient.NewFleetCreateSubscriptionOnBehalfOfCustomerRequest2("Dolor at ducimus voluptatibus exercitationem.", "Iure officia ea et.") // FleetCreateSubscriptionOnBehalfOfCustomerRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | The service ID this workflow belongs to.
	productTierId := "pt-12345678" // string | The product tier ID that this upgrade path belongs to
	createUpgradePathRequest2 := *openapiclient.NewCreateUpgradePathRequest2("1.0", "2.0", map[string][]string{"key": []string{"Ut laboriosam consequatur et hic dolores excepturi."}}) // CreateUpgradePathRequest2 | 
...
func main() {
	...
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	instanceId := "instance-12345678" // string | The resource instance ID.
	fleetDeleteResourceInstanceRequest2 := *openapiclient.NewFleetDeleteResourceInstanceRequest2("Error sed praesentium ut.") // FleetDeleteResourceInstanceRequest2 | 
...
> InventoryApiDeleteResourceInstanceSnapshot(ctx, serviceId, environmentId, snapshotId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.InventoryApiAPI.InventoryApiDeleteResourceInstanceSnapshot(context.Background(), serviceId, environmentId, snapshotId).Execute()
	if err != nil {
...
func main() {
	...
	// response from `InventoryApiImportAccountConfigCloudNativeNetwork`: FleetListAccountConfigCloudNativeNetworksResult
	fmt.Fprintf(os.Stdout, "Response from `InventoryApiAPI.InventoryApiImportAccountConfigCloudNativeNetwork`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiInventoryApiImportAccountConfigCloudNativeNetworkRequest struct via the builder pattern
...
## InventoryApiListAccountConfigCloudNativeNetworks

> FleetListAccountConfigCloudNativeNetworksResult InventoryApiListAccountConfigCloudNativeNetworks(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InventoryApiAPI.InventoryApiListAccountConfigCloudNativeNetworks(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InventoryApiAPI.InventoryApiListAccountConfigCloudNativeNetworks``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `InventoryApiListAccountConfigCloudNativeNetworks`: FleetListAccountConfigCloudNativeNetworksResult
	fmt.Fprintf(os.Stdout, "Response from `InventoryApiAPI.InventoryApiListAccountConfigCloudNativeNetworks`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiInventoryApiListAccountConfigCloudNativeNetworksRequest struct via the builder pattern
...
func main() {
	fleetListAccountConfigsRequest2 := *openapiclient.NewFleetListAccountConfigsRequest2("aws|azure|gcp|nebius|oci|byoc-onprem|all") // FleetListAccountConfigsRequest2 | 
...
## InventoryApiListAllSnapshotsInHostCluster

> ListAllSnapshotsInHostClusterResult InventoryApiListAllSnapshotsInHostCluster(ctx, hostClusterId).NextPageToken(nextPageToken).PageSize(pageSize).Execute()
...
func main() {
	hostClusterId := "hc-12345678" // string | ID of the host cluster to list snapshots for
	nextPageToken := "token" // string |  (optional)
	pageSize := int64(10) // int64 |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InventoryApiAPI.InventoryApiListAllSnapshotsInHostCluster(context.Background(), hostClusterId).NextPageToken(nextPageToken).PageSize(pageSize).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InventoryApiAPI.InventoryApiListAllSnapshotsInHostCluster``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `InventoryApiListAllSnapshotsInHostCluster`: ListAllSnapshotsInHostClusterResult
	fmt.Fprintf(os.Stdout, "Response from `InventoryApiAPI.InventoryApiListAllSnapshotsInHostCluster`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**hostClusterId** | **string** | ID of the host cluster to list snapshots for | 

### Other Parameters

Other parameters are passed through a pointer to a apiInventoryApiListAllSnapshotsInHostClusterRequest struct via the builder pattern
...
[**ListAllSnapshotsInHostClusterResult**](ListAllSnapshotsInHostClusterResult.md)
...
## InventoryApiListInstanceUpgradeHistory

> ListInstanceUpgradeHistoryResult InventoryApiListInstanceUpgradeHistory(ctx, serviceId, environmentId, instanceId).NextPageToken(nextPageToken).PageSize(pageSize).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InventoryApiAPI.InventoryApiListInstanceUpgradeHistory(context.Background(), serviceId, environmentId, instanceId).NextPageToken(nextPageToken).PageSize(pageSize).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InventoryApiAPI.InventoryApiListInstanceUpgradeHistory``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `InventoryApiListInstanceUpgradeHistory`: ListInstanceUpgradeHistoryResult
	fmt.Fprintf(os.Stdout, "Response from `InventoryApiAPI.InventoryApiListInstanceUpgradeHistory`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiInventoryApiListInstanceUpgradeHistoryRequest struct via the builder pattern
...
[**ListInstanceUpgradeHistoryResult**](ListInstanceUpgradeHistoryResult.md)
...
> FleetListLinkedInstancesResult InventoryApiListLinkedInstances(ctx, serviceId, environmentId, instanceId).ExcludeNetworkTopology(excludeNetworkTopology).ExcludeHAStatus(excludeHAStatus).ExcludeIntegrations(excludeIntegrations).ExcludeMaintenanceTasks(excludeMaintenanceTasks).Execute()
...
func main() {
	...
	excludeMaintenanceTasks := false // bool | Whether to exclude maintenance tasks from the response. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InventoryApiAPI.InventoryApiListLinkedInstances(context.Background(), serviceId, environmentId, instanceId).ExcludeNetworkTopology(excludeNetworkTopology).ExcludeHAStatus(excludeHAStatus).ExcludeIntegrations(excludeIntegrations).ExcludeMaintenanceTasks(excludeMaintenanceTasks).Execute()
	if err != nil {
 ...
 **excludeMaintenanceTasks** | **bool** | Whether to exclude maintenance tasks from the response. | 
...
func main() {
	serviceId := "s-12345678" // string | The service ID this workflow belongs to.
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	productTierVersion := "Nam aut eos est non voluptates." // string | Product tier version of the instance to describe. If not specified, the latest version is described. (optional)
...
> InventoryListServiceOfferingsResult InventoryApiListServiceOfferings(ctx).Visibility(visibility).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InventoryApiAPI.InventoryApiListServiceOfferings(context.Background()).Visibility(visibility).Execute()
	if err != nil {
...
func main() {
	...
	productTierId := "pt-12345678" // string | The product tier ID that this upgrade path belongs to
	upgradePathId := "up-12345678" // string | The upgrade path ID
	manageUpgradePathLifecycleRequest2 := *openapiclient.NewManageUpgradePathLifecycleRequest2("pause|cancel|resume|skip-instances|notify-customer") // ManageUpgradePathLifecycleRequest2 | 
...
func main() {
	id := "so-12345678" // string | The ID of the services orchestration
	fleetModifyServicesOrchestrationRequest2 := *openapiclient.NewFleetModifyServicesOrchestrationRequest2("Voluptas magni.") // FleetModifyServicesOrchestrationRequest2 | 
...
func main() {
	...
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	instanceId := "instance-12345678" // string | The resource instance ID.
	oneOffPatchResourceInstanceRequest2 := *openapiclient.NewOneOffPatchResourceInstanceRequest2("Neque ad.") // OneOffPatchResourceInstanceRequest2 | 
...
func main() {
	...
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	instanceId := "instance-12345678" // string | The resource instance ID.
	fleetRemoveCapacityFromResourceInstanceRequest2 := *openapiclient.NewFleetRemoveCapacityFromResourceInstanceRequest2(int64(3), "Aspernatur saepe maiores at repellendus quisquam.") // FleetRemoveCapacityFromResourceInstanceRequest2 | 
...
## InventoryApiResendVerificationEmail

> InventoryApiResendVerificationEmail(ctx, userId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.InventoryApiAPI.InventoryApiResendVerificationEmail(context.Background(), userId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InventoryApiAPI.InventoryApiResendVerificationEmail``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiInventoryApiResendVerificationEmailRequest struct via the builder pattern
...
func main() {
	...
	fleetResourceInstanceCustomWorkflowRequest2 := *openapiclient.NewFleetResourceInstanceCustomWorkflowRequest2("Voluptatem et modi temporibus.") // FleetResourceInstanceCustomWorkflowRequest2 | 
...
func main() {
	...
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	instanceId := "instance-12345678" // string | The resource instance ID.
	fleetRestartResourceInstanceRequest2 := *openapiclient.NewFleetRestartResourceInstanceRequest2("Sequi delectus voluptates consequatur aspernatur unde similique.") // FleetRestartResourceInstanceRequest2 | 
...
func main() {
	searchInventoryRequest2 := *openapiclient.NewSearchInventoryRequest2("snapshot:instance-12345678") // SearchInventoryRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | The service ID this workflow belongs to.
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	searchServiceInventoryRequest2 := *openapiclient.NewSearchServiceInventoryRequest2("snapshot:instance-12345678") // SearchServiceInventoryRequest2 | 
...
func main() {
	...
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	instanceId := "instance-12345678" // string | The resource instance ID.
	fleetStartResourceInstanceRequest2 := *openapiclient.NewFleetStartResourceInstanceRequest2("Rem explicabo magnam quibusdam aut temporibus.") // FleetStartResourceInstanceRequest2 | 
...
func main() {
	...
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	instanceId := "instance-12345678" // string | The resource instance ID.
	fleetStopResourceInstanceRequest2 := *openapiclient.NewFleetStopResourceInstanceRequest2("Eaque pariatur veritatis exercitationem laboriosam nesciunt aut.") // FleetStopResourceInstanceRequest2 | 
...
## InventoryApiSyncAccountConfigCloudNativeNetworks

> FleetListAccountConfigCloudNativeNetworksResult InventoryApiSyncAccountConfigCloudNativeNetworks(ctx, id).FleetSyncAccountConfigCloudNativeNetworksRequest2(fleetSyncAccountConfigCloudNativeNetworksRequest2).Execute()
...
func main() {
	id := "ac-12345678" // string | Account Config ID to operate on
	fleetSyncAccountConfigCloudNativeNetworksRequest2 := *openapiclient.NewFleetSyncAccountConfigCloudNativeNetworksRequest2() // FleetSyncAccountConfigCloudNativeNetworksRequest2 | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.InventoryApiAPI.InventoryApiSyncAccountConfigCloudNativeNetworks(context.Background(), id).FleetSyncAccountConfigCloudNativeNetworksRequest2(fleetSyncAccountConfigCloudNativeNetworksRequest2).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InventoryApiAPI.InventoryApiSyncAccountConfigCloudNativeNetworks``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `InventoryApiSyncAccountConfigCloudNativeNetworks`: FleetListAccountConfigCloudNativeNetworksResult
	fmt.Fprintf(os.Stdout, "Response from `InventoryApiAPI.InventoryApiSyncAccountConfigCloudNativeNetworks`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiInventoryApiSyncAccountConfigCloudNativeNetworksRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **fleetSyncAccountConfigCloudNativeNetworksRequest2** | [**FleetSyncAccountConfigCloudNativeNetworksRequest2**](FleetSyncAccountConfigCloudNativeNetworksRequest2.md) |  | 
...
func main() {
	...
	// response from `InventoryApiUnimportAccountConfigCloudNativeNetwork`: FleetListAccountConfigCloudNativeNetworksResult
	fmt.Fprintf(os.Stdout, "Response from `InventoryApiAPI.InventoryApiUnimportAccountConfigCloudNativeNetwork`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiInventoryApiUnimportAccountConfigCloudNativeNetworkRequest struct via the builder pattern
...
## InventoryApiUpdateConsumptionUser

> InventoryApiUpdateConsumptionUser(ctx, userId).FleetUpdateConsumptionUserRequest2(fleetUpdateConsumptionUserRequest2).Execute()
...
func main() {
	userId := "user-12345678" // string | The user ID
	fleetUpdateConsumptionUserRequest2 := *openapiclient.NewFleetUpdateConsumptionUserRequest2() // FleetUpdateConsumptionUserRequest2 | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.InventoryApiAPI.InventoryApiUpdateConsumptionUser(context.Background(), userId).FleetUpdateConsumptionUserRequest2(fleetUpdateConsumptionUserRequest2).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `InventoryApiAPI.InventoryApiUpdateConsumptionUser``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiInventoryApiUpdateConsumptionUserRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **fleetUpdateConsumptionUserRequest2** | [**FleetUpdateConsumptionUserRequest2**](FleetUpdateConsumptionUserRequest2.md) |  | 
...
func main() {
	...
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	instanceId := "instance-12345678" // string | The resource instance ID.
	fleetUpdateResourceInstanceRequest2 := *openapiclient.NewFleetUpdateResourceInstanceRequest2("Illo reprehenderit assumenda praesentium libero consequatur.") // FleetUpdateResourceInstanceRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | The service ID this workflow belongs to.
	environmentId := "se-12345678" // string | The service environment ID this workflow belongs to.
	fleetUpdateSubscriptionsRequest2 := *openapiclient.NewFleetUpdateSubscriptionsRequest2([]string{"Nihil ipsa vero quos."}) // FleetUpdateSubscriptionsRequest2 | 
