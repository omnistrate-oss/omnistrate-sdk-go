...
func main() {
	adoptHostClusterRequest2 := *openapiclient.NewAdoptHostClusterRequest2("aws|azure|gcp|all", "My Adopted Host Cluster", "Facilis voluptate saepe.", "us-east-1") // AdoptHostClusterRequest2 | 
