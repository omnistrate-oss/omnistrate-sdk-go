...
func main() {
	adoptHostClusterRequest2 := *openapiclient.NewAdoptHostClusterRequest2("aws|azure|gcp|all", "My Adopted Host Cluster", "Vel et similique.", "us-east-1") // AdoptHostClusterRequest2 | 
