...
func main() {
	adoptHostClusterRequest2 := *openapiclient.NewAdoptHostClusterRequest2("aws|azure|gcp|nebius|oci|byoc-onprem|all", "My Adopted Host Cluster", "Et est harum et optio aliquid sit.", "us-east-1") // AdoptHostClusterRequest2 | 
