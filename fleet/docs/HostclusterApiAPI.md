...
func main() {
	adoptHostClusterRequest2 := *openapiclient.NewAdoptHostClusterRequest2("aws|azure|gcp|nebius|oci|byoc-onprem|all", "My Adopted Host Cluster", "Eveniet iure inventore repellat.", "us-east-1") // AdoptHostClusterRequest2 | 
