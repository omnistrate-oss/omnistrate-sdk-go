...
func main() {
	adoptHostClusterRequest2 := *openapiclient.NewAdoptHostClusterRequest2("aws|azure|gcp|nebius|oci|byoc-onprem|all", "My Adopted Host Cluster", "Enim et veniam voluptatibus corporis eum sit.", "us-east-1") // AdoptHostClusterRequest2 | 
