...
func main() {
	adoptHostClusterRequest2 := *openapiclient.NewAdoptHostClusterRequest2("aws|azure|gcp|all", "My Adopted Host Cluster", "Enim non.", "us-east-1") // AdoptHostClusterRequest2 | 
