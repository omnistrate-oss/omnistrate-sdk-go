...
func main() {
	fleetCreateCustomNetworkRequest2 := *openapiclient.NewFleetCreateCustomNetworkRequest2("10.0.0.0/16", "aws|azure|gcp|nebius|oci|byoc-onprem|all", "us-east-1") // FleetCreateCustomNetworkRequest2 | 
