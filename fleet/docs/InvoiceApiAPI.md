...
func main() {
	fleetCreateInvoiceRequest2 := *openapiclient.NewFleetCreateInvoiceRequest2("2025-01", "Soluta mollitia voluptatibus recusandae temporibus exercitationem optio.") // FleetCreateInvoiceRequest2 | 
