...
// APIClient manages communication with the Omnistrate Fleet API API v2022-09-01-00
...
type APIClient struct {
	...
	CustomerOnboardingsApiAPI *CustomerOnboardingsApiAPIService

	EventsApiAPI *EventsApiAPIService

	FleetFeaturesApiAPI *FleetFeaturesApiAPIService

	FleetWorkflowsApiAPI *FleetWorkflowsApiAPIService

	HelmPackageApiAPI *HelmPackageApiAPIService

	HostclusterApiAPI *HostclusterApiAPIService

	IntegrationsApiAPI *IntegrationsApiAPIService

	InventoryApiAPI *InventoryApiAPIService

	NotificationsApiAPI *NotificationsApiAPIService

	OperationsApiAPI *OperationsApiAPIService

	WebhooksApiAPI *WebhooksApiAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.IntegrationsApiAPI = (*IntegrationsApiAPIService)(&c.common)
