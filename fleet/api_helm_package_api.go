...
type HelmPackageApiAPI interface {
	...
	@param chartName The chart name of the Helm package
	@param chartVersion The chart version of the Helm package
	...
	*/
	...
	//  @return HelmPackage
	HelmPackageApiSaveHelmPackageExecute(r ApiHelmPackageApiSaveHelmPackageRequest) (*HelmPackage, *http.Response, error)
}
...
func (a *HelmPackageApiAPIService) HelmPackageApiDeleteHelmPackageExecute(r ApiHelmPackageApiDeleteHelmPackageRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/2022-09-01-00/fleet/helm-package/{chartName}/{chartVersion}"
...
func (a *HelmPackageApiAPIService) HelmPackageApiListHelmPackagesExecute(r ApiHelmPackageApiListHelmPackagesRequest) (*ListHelmPackagesResult, *http.Response, error) {
	...
	localVarPath := localBasePath + "/2022-09-01-00/fleet/helm-package"
...
func (r ApiHelmPackageApiSaveHelmPackageRequest) Execute() (*HelmPackage, *http.Response, error) {
...
// Execute executes the request
//  @return HelmPackage
func (a *HelmPackageApiAPIService) HelmPackageApiSaveHelmPackageExecute(r ApiHelmPackageApiSaveHelmPackageRequest) (*HelmPackage, *http.Response, error) {
	var (
	...
	if r.saveHelmPackageRequestBody == nil {
		return localVarReturnValue, nil, reportError("saveHelmPackageRequestBody is required and must be specified")
	}
