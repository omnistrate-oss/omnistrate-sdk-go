...
// checks if the StopResourceInstanceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StopResourceInstanceRequest{}

// StopResourceInstanceRequest struct for StopResourceInstanceRequest
type StopResourceInstanceRequest struct {
	// The instance ID
	Id string `json:"id"`
...
type _StopResourceInstanceRequest StopResourceInstanceRequest
...
func NewStopResourceInstanceRequest(id string, productTierKey string, resourceKey string, serviceAPIVersion string, serviceEnvironmentKey string, serviceKey string, serviceModelKey string, serviceProviderId string, token string) *StopResourceInstanceRequest {
	this := StopResourceInstanceRequest{}
	this.Id = id
...
func (o StopResourceInstanceRequest) MarshalJSON() ([]byte, error) {
...
func (o StopResourceInstanceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *StopResourceInstanceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varStopResourceInstanceRequest := _StopResourceInstanceRequest{}

	err = json.Unmarshal(data, &varStopResourceInstanceRequest)

	if err != nil {
		return err
	}

	*o = StopResourceInstanceRequest(varStopResourceInstanceRequest)
...
type NullableStopResourceInstanceRequest struct {
	value *StopResourceInstanceRequest
	isSet bool
}

func (v NullableStopResourceInstanceRequest) Get() *StopResourceInstanceRequest {
	return v.value
}

func (v *NullableStopResourceInstanceRequest) Set(val *StopResourceInstanceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStopResourceInstanceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStopResourceInstanceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStopResourceInstanceRequest(val *StopResourceInstanceRequest) *NullableStopResourceInstanceRequest {
	return &NullableStopResourceInstanceRequest{value: val, isSet: true}
}

func (v NullableStopResourceInstanceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStopResourceInstanceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
