...
// checks if the DescribeRegionCostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeRegionCostRequest{}

// DescribeRegionCostRequest struct for DescribeRegionCostRequest
type DescribeRegionCostRequest struct {
...
type _DescribeRegionCostRequest DescribeRegionCostRequest
...
func NewDescribeRegionCostRequest(endDate time.Time, environmentType string, frequency string, startDate time.Time, token string) *DescribeRegionCostRequest {
	this := DescribeRegionCostRequest{}
...
func (o DescribeRegionCostRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeRegionCostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeRegionCostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeRegionCostRequest := _DescribeRegionCostRequest{}

	err = json.Unmarshal(data, &varDescribeRegionCostRequest)

	if err != nil {
		return err
	}

	*o = DescribeRegionCostRequest(varDescribeRegionCostRequest)
...
type NullableDescribeRegionCostRequest struct {
	value *DescribeRegionCostRequest
	isSet bool
}

func (v NullableDescribeRegionCostRequest) Get() *DescribeRegionCostRequest {
	return v.value
}

func (v *NullableDescribeRegionCostRequest) Set(val *DescribeRegionCostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeRegionCostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeRegionCostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeRegionCostRequest(val *DescribeRegionCostRequest) *NullableDescribeRegionCostRequest {
	return &NullableDescribeRegionCostRequest{value: val, isSet: true}
}

func (v NullableDescribeRegionCostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeRegionCostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
