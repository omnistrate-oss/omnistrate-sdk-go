...
func Test_openapi_HelmPackageApiAPIService(t *testing.T) {
	...
	t.Run("Test HelmPackageApiAPIService HelmPackageApiSaveHelmPackage", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.HelmPackageApiAPI.HelmPackageApiSaveHelmPackage(context.Background()).Execute()
