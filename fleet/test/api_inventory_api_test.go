...
func Test_fleet_InventoryApiAPIService(t *testing.T) {
	...
	t.Run("Test InventoryApiAPIService InventoryApiCopyResourceInstanceSnapshot", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.InventoryApiAPI.InventoryApiCopyResourceInstanceSnapshot(context.Background(), serviceId, environmentId, instanceId).Execute()
	...
	t.Run("Test InventoryApiAPIService InventoryApiDescribeResourceInstanceInstaller", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.InventoryApiAPI.InventoryApiDescribeResourceInstanceInstaller(context.Background(), serviceId, environmentId, instanceId).Execute()
	...
	t.Run("Test InventoryApiAPIService InventoryApiListAccountConfigCloudNativeNetworks", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id string

		resp, httpRes, err := apiClient.InventoryApiAPI.InventoryApiListAccountConfigCloudNativeNetworks(context.Background(), id).Execute()
	...
	t.Run("Test InventoryApiAPIService InventoryApiListAllOrganizations", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.InventoryApiAPI.InventoryApiListAllOrganizations(context.Background()).Execute()
	...
	t.Run("Test InventoryApiAPIService InventoryApiListAllSnapshotsInHostCluster", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var hostClusterId string

		resp, httpRes, err := apiClient.InventoryApiAPI.InventoryApiListAllSnapshotsInHostCluster(context.Background(), hostClusterId).Execute()
	...
	t.Run("Test InventoryApiAPIService InventoryApiListInstanceUpgradeHistory", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.InventoryApiAPI.InventoryApiListInstanceUpgradeHistory(context.Background(), serviceId, environmentId, instanceId).Execute()
	...
	t.Run("Test InventoryApiAPIService InventoryApiOneOffPatchResourceInstance", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.InventoryApiAPI.InventoryApiOneOffPatchResourceInstance(context.Background(), serviceId, environmentId, instanceId).Execute()
	...
	t.Run("Test InventoryApiAPIService InventoryApiResendVerificationEmail", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var userId string

		httpRes, err := apiClient.InventoryApiAPI.InventoryApiResendVerificationEmail(context.Background(), userId).Execute()
