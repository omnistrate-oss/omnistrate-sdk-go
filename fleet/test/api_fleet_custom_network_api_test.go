...
func Test_fleet_FleetCustomNetworkApiAPIService(t *testing.T) {
	...
	t.Run("Test FleetCustomNetworkApiAPIService FleetCustomNetworkApiUpdateCustomNetwork", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id string

		resp, httpRes, err := apiClient.FleetCustomNetworkApiAPI.FleetCustomNetworkApiUpdateCustomNetwork(context.Background(), id).Execute()
