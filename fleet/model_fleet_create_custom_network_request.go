...
// checks if the FleetCreateCustomNetworkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FleetCreateCustomNetworkRequest{}

// FleetCreateCustomNetworkRequest struct for FleetCreateCustomNetworkRequest
type FleetCreateCustomNetworkRequest struct {
...
type _FleetCreateCustomNetworkRequest FleetCreateCustomNetworkRequest
...
func NewFleetCreateCustomNetworkRequest(cidr string, cloudProviderName string, cloudProviderRegion string, token string) *FleetCreateCustomNetworkRequest {
	this := FleetCreateCustomNetworkRequest{}
	this.Cidr = cidr
...
func (o FleetCreateCustomNetworkRequest) MarshalJSON() ([]byte, error) {
...
func (o FleetCreateCustomNetworkRequest) ToMap() (map[string]interface{}, error) {
...
func (o *FleetCreateCustomNetworkRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varFleetCreateCustomNetworkRequest := _FleetCreateCustomNetworkRequest{}

	err = json.Unmarshal(data, &varFleetCreateCustomNetworkRequest)

	if err != nil {
		return err
	}

	*o = FleetCreateCustomNetworkRequest(varFleetCreateCustomNetworkRequest)
...
type NullableFleetCreateCustomNetworkRequest struct {
	value *FleetCreateCustomNetworkRequest
	isSet bool
}

func (v NullableFleetCreateCustomNetworkRequest) Get() *FleetCreateCustomNetworkRequest {
	return v.value
}

func (v *NullableFleetCreateCustomNetworkRequest) Set(val *FleetCreateCustomNetworkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableFleetCreateCustomNetworkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableFleetCreateCustomNetworkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFleetCreateCustomNetworkRequest(val *FleetCreateCustomNetworkRequest) *NullableFleetCreateCustomNetworkRequest {
	return &NullableFleetCreateCustomNetworkRequest{value: val, isSet: true}
}

func (v NullableFleetCreateCustomNetworkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFleetCreateCustomNetworkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
