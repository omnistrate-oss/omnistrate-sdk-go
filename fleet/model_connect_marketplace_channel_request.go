...
// checks if the ConnectMarketplaceChannelRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectMarketplaceChannelRequest{}
...
type _ConnectMarketplaceChannelRequest ConnectMarketplaceChannelRequest
...
func NewConnectMarketplaceChannelRequest(channel string, token string) *ConnectMarketplaceChannelRequest {
	this := ConnectMarketplaceChannelRequest{}
...
func (o ConnectMarketplaceChannelRequest) MarshalJSON() ([]byte, error) {
...
func (o ConnectMarketplaceChannelRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectMarketplaceChannelRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varConnectMarketplaceChannelRequest := _ConnectMarketplaceChannelRequest{}

	err = json.Unmarshal(data, &varConnectMarketplaceChannelRequest)

	if err != nil {
		return err
	}

	*o = ConnectMarketplaceChannelRequest(varConnectMarketplaceChannelRequest)
...
type NullableConnectMarketplaceChannelRequest struct {
	value *ConnectMarketplaceChannelRequest
	isSet bool
}

func (v NullableConnectMarketplaceChannelRequest) Get() *ConnectMarketplaceChannelRequest {
	return v.value
}

func (v *NullableConnectMarketplaceChannelRequest) Set(val *ConnectMarketplaceChannelRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectMarketplaceChannelRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectMarketplaceChannelRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectMarketplaceChannelRequest(val *ConnectMarketplaceChannelRequest) *NullableConnectMarketplaceChannelRequest {
	return &NullableConnectMarketplaceChannelRequest{value: val, isSet: true}
}

func (v NullableConnectMarketplaceChannelRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectMarketplaceChannelRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
