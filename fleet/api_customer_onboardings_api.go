...
type CustomerOnboardingsApiAPI interface {
	...
	*/
	...
	/*
	CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboarding GenerateServicePlanSpecOrComposeSpecForOnboarding customer-onboardings-api

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The ID of the onboarding.
	@return ApiCustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingRequest
	*/
	CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboarding(ctx context.Context, id string) ApiCustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingRequest

	// CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingExecute executes the request
	//  @return GenerateServicePlanSpecOrComposeSpecForOnboardingResult
	CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingExecute(r ApiCustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingRequest) (*GenerateServicePlanSpecOrComposeSpecForOnboardingResult, *http.Response, error)
	...
	*/
	...
	/*
	CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifact ScrutinizeOnboardingDeploymentArtifact customer-onboardings-api

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The ID of the onboarding.
	@return ApiCustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactRequest
	*/
	CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifact(ctx context.Context, id string) ApiCustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactRequest

	// CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactExecute executes the request
	CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactExecute(r ApiCustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactRequest) (*http.Response, error)
...
type ApiCustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingRequest struct {
	ctx context.Context
	ApiService CustomerOnboardingsApiAPI
	id string
}

func (r ApiCustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingRequest) Execute() (*GenerateServicePlanSpecOrComposeSpecForOnboardingResult, *http.Response, error) {
	return r.ApiService.CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingExecute(r)
}
...
CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboarding GenerateServicePlanSpecOrComposeSpecForOnboarding customer-onboardings-api
 ...
 @return ApiCustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingRequest
*/
func (a *CustomerOnboardingsApiAPIService) CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboarding(ctx context.Context, id string) ApiCustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingRequest {
	return ApiCustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GenerateServicePlanSpecOrComposeSpecForOnboardingResult
func (a *CustomerOnboardingsApiAPIService) CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingExecute(r ApiCustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboardingRequest) (*GenerateServicePlanSpecOrComposeSpecForOnboardingResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GenerateServicePlanSpecOrComposeSpecForOnboardingResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerOnboardingsApiAPIService.CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboarding")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2022-09-01-00/fleet/customer-onboarding/generate-spec/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiCustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactRequest struct {
	ctx context.Context
	ApiService CustomerOnboardingsApiAPI
	id string
}

func (r ApiCustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactRequest) Execute() (*http.Response, error) {
	return r.ApiService.CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactExecute(r)
}
...
CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifact ScrutinizeOnboardingDeploymentArtifact customer-onboardings-api
 ...
 @return ApiCustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactRequest
*/
func (a *CustomerOnboardingsApiAPIService) CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifact(ctx context.Context, id string) ApiCustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactRequest {
	return ApiCustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *CustomerOnboardingsApiAPIService) CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactExecute(r ApiCustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifactRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerOnboardingsApiAPIService.CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifact")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2022-09-01-00/fleet/customer-onboarding/{id}/scrutinize-deployment-artifact"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
