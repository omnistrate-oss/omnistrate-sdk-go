...
*CustomerOnboardingsApiAPI* | [**CustomerOnboardingsApiGenerateServicePlanSpecOrComposeSpecForOnboarding**](docs/CustomerOnboardingsApiAPI.md#customeronboardingsapigenerateserviceplanspecorcomposespecforonboarding) | **Post** /2022-09-01-00/fleet/customer-onboarding/generate-spec/{id} | GenerateServicePlanSpecOrComposeSpecForOnboarding customer-onboardings-api
...
*CustomerOnboardingsApiAPI* | [**CustomerOnboardingsApiScrutinizeOnboardingDeploymentArtifact**](docs/CustomerOnboardingsApiAPI.md#customeronboardingsapiscrutinizeonboardingdeploymentartifact) | **Post** /2022-09-01-00/fleet/customer-onboarding/{id}/scrutinize-deployment-artifact | ScrutinizeOnboardingDeploymentArtifact customer-onboardings-api
...
*HostclusterApiAPI* | [**HostclusterApiTerminateDeploymentCellWorkflow**](docs/HostclusterApiAPI.md#hostclusterapiterminatedeploymentcellworkflow) | **Delete** /2022-09-01-00/fleet/host-cluster/{hostClusterID}/workflow/{workflowID} | TerminateDeploymentCellWorkflow hostcluster-api
*HostclusterApiAPI* | [**HostclusterApiUpdateDeploymentCellWorkflow**](docs/HostclusterApiAPI.md#hostclusterapiupdatedeploymentcellworkflow) | **Patch** /2022-09-01-00/fleet/host-cluster/{hostClusterID}/workflow/{workflowID} | UpdateDeploymentCellWorkflow hostcluster-api
...
*InventoryApiAPI* | [**InventoryApiListAllResourceInstanceSnapshots**](docs/InventoryApiAPI.md#inventoryapilistallresourceinstancesnapshots) | **Get** /2022-09-01-00/fleet/service/{serviceId}/environment/{environmentId}/snapshot | ListAllResourceInstanceSnapshots inventory-api
*InventoryApiAPI* | [**InventoryApiListAllSnapshotsInHostCluster**](docs/InventoryApiAPI.md#inventoryapilistallsnapshotsinhostcluster) | **Get** /2022-09-01-00/fleet/host-clusters/{hostClusterId}/snapshots | ListAllSnapshotsInHostCluster inventory-api
...
*InventoryApiAPI* | [**InventoryApiListInstanceUpgradeHistory**](docs/InventoryApiAPI.md#inventoryapilistinstanceupgradehistory) | **Get** /2022-09-01-00/fleet/service/{serviceId}/environment/{environmentId}/instance/{instanceId}/upgrade-history | ListInstanceUpgradeHistory inventory-api
...
*InventoryApiAPI* | [**InventoryApiUpdateResourceInstanceMetadata**](docs/InventoryApiAPI.md#inventoryapiupdateresourceinstancemetadata) | **Patch** /2022-09-01-00/fleet/service/{serviceId}/environment/{environmentId}/instance/{instanceId}/metadata | UpdateResourceInstanceMetadata inventory-api
...
*MarketplaceApiAPI* | [**MarketplaceApiConfirmMarketplaceFulfillment**](docs/MarketplaceApiAPI.md#marketplaceapiconfirmmarketplacefulfillment) | **Post** /2022-09-01-00/fleet/marketplace/contract/{id}/fulfillment/confirm | ConfirmMarketplaceFulfillment marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiConnectMarketplaceChannel**](docs/MarketplaceApiAPI.md#marketplaceapiconnectmarketplacechannel) | **Post** /2022-09-01-00/fleet/marketplace/channel | ConnectMarketplaceChannel marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiDenyMarketplaceFulfillment**](docs/MarketplaceApiAPI.md#marketplaceapidenymarketplacefulfillment) | **Post** /2022-09-01-00/fleet/marketplace/contract/{id}/fulfillment/deny | DenyMarketplaceFulfillment marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiDescribeMarketplaceChannel**](docs/MarketplaceApiAPI.md#marketplaceapidescribemarketplacechannel) | **Get** /2022-09-01-00/fleet/marketplace/channel/{channel} | DescribeMarketplaceChannel marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiDescribeMarketplaceContract**](docs/MarketplaceApiAPI.md#marketplaceapidescribemarketplacecontract) | **Get** /2022-09-01-00/fleet/marketplace/contract/{id} | DescribeMarketplaceContract marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiDescribeMarketplaceFulfillment**](docs/MarketplaceApiAPI.md#marketplaceapidescribemarketplacefulfillment) | **Get** /2022-09-01-00/fleet/marketplace/contract/{id}/fulfillment | DescribeMarketplaceFulfillment marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiDescribeSandboxRun**](docs/MarketplaceApiAPI.md#marketplaceapidescribesandboxrun) | **Get** /2022-09-01-00/fleet/marketplace/sandbox/run | DescribeSandboxRun marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiDisconnectMarketplaceChannel**](docs/MarketplaceApiAPI.md#marketplaceapidisconnectmarketplacechannel) | **Delete** /2022-09-01-00/fleet/marketplace/channel/{channel} | DisconnectMarketplaceChannel marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiListMarketplaceChannelListings**](docs/MarketplaceApiAPI.md#marketplaceapilistmarketplacechannellistings) | **Get** /2022-09-01-00/fleet/marketplace/channel/{channel}/listing | ListMarketplaceChannelListings marketplace-api
...
*MarketplaceApiAPI* | [**MarketplaceApiRetryMarketplaceFulfillment**](docs/MarketplaceApiAPI.md#marketplaceapiretrymarketplacefulfillment) | **Post** /2022-09-01-00/fleet/marketplace/contract/{id}/fulfillment/retry | RetryMarketplaceFulfillment marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiRotateSandboxSecret**](docs/MarketplaceApiAPI.md#marketplaceapirotatesandboxsecret) | **Post** /2022-09-01-00/fleet/marketplace/sandbox/secret/rotate | RotateSandboxSecret marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiSandboxCheckout**](docs/MarketplaceApiAPI.md#marketplaceapisandboxcheckout) | **Get** /2022-09-01-00/fleet/marketplace/sandbox/checkout/{externalRef} | SandboxCheckout marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiSendSandboxEvent**](docs/MarketplaceApiAPI.md#marketplaceapisendsandboxevent) | **Post** /2022-09-01-00/fleet/marketplace/sandbox/event | SendSandboxEvent marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiSimulateContractEvent**](docs/MarketplaceApiAPI.md#marketplaceapisimulatecontractevent) | **Post** /2022-09-01-00/fleet/marketplace/sandbox/simulate | SimulateContractEvent marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiStartSandboxRun**](docs/MarketplaceApiAPI.md#marketplaceapistartsandboxrun) | **Post** /2022-09-01-00/fleet/marketplace/sandbox/run | StartSandboxRun marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiUpdateMarketplaceChannel**](docs/MarketplaceApiAPI.md#marketplaceapiupdatemarketplacechannel) | **Patch** /2022-09-01-00/fleet/marketplace/channel/{channel} | UpdateMarketplaceChannel marketplace-api
*MarketplaceApiAPI* | [**MarketplaceApiValidateMarketplaceChannel**](docs/MarketplaceApiAPI.md#marketplaceapivalidatemarketplacechannel) | **Post** /2022-09-01-00/fleet/marketplace/channel/{channel}/validate | ValidateMarketplaceChannel marketplace-api
...
*NotificationsApiAPI* | [**NotificationsApiGetEventCategoryTypeMap**](docs/NotificationsApiAPI.md#notificationsapigeteventcategorytypemap) | **Get** /2022-09-01-00/fleet/notification-channel/event-category-type-map | GetEventCategoryTypeMap notifications-api
...
*UsageApiAPI* | [**UsageApiGetConsolidatedUsage**](docs/UsageApiAPI.md#usageapigetconsolidatedusage) | **Get** /2022-09-01-00/fleet/service/{serviceId}/environment/{environmentId}/usage | GetConsolidatedUsage usage-api
...
## Documentation For Models
 ...
 - [CloudNativeOnboardingMetadata](docs/CloudNativeOnboardingMetadata.md)
 ...
 - [ConfirmMarketplaceFulfillmentRequest](docs/ConfirmMarketplaceFulfillmentRequest.md)
 - [ConfirmMarketplaceFulfillmentRequest2](docs/ConfirmMarketplaceFulfillmentRequest2.md)
 - [ConnectMarketplaceChannelRequest](docs/ConnectMarketplaceChannelRequest.md)
 - [ConnectMarketplaceChannelRequest2](docs/ConnectMarketplaceChannelRequest2.md)
 ...
 - [ContainerImageOnboardingMetadata](docs/ContainerImageOnboardingMetadata.md)
 - [CopyInstanceSnapshotRequest](docs/CopyInstanceSnapshotRequest.md)
 ...
 - [DenyMarketplaceFulfillmentRequest](docs/DenyMarketplaceFulfillmentRequest.md)
 - [DenyMarketplaceFulfillmentRequest2](docs/DenyMarketplaceFulfillmentRequest2.md)
 ...
 - [DescribeInstanceSnapshotRequest](docs/DescribeInstanceSnapshotRequest.md)
 - [DescribeInstanceSnapshotResult](docs/DescribeInstanceSnapshotResult.md)
 ...
 - [DescribeMarketplaceChannelRequest](docs/DescribeMarketplaceChannelRequest.md)
 - [DescribeMarketplaceContractRequest](docs/DescribeMarketplaceContractRequest.md)
 - [DescribeMarketplaceFulfillmentRequest](docs/DescribeMarketplaceFulfillmentRequest.md)
 ...
 - [DescribeSandboxRunRequest](docs/DescribeSandboxRunRequest.md)
 ...
 - [DisconnectMarketplaceChannelRequest](docs/DisconnectMarketplaceChannelRequest.md)
 - [DockerComposeOnboardingMetadata](docs/DockerComposeOnboardingMetadata.md)
 ...
 - [FleetGetConsolidatedUsageRequest](docs/FleetGetConsolidatedUsageRequest.md)
 - [FleetGetConsolidatedUsageResult](docs/FleetGetConsolidatedUsageResult.md)
 ...
 - [FleetNebiusAccountBindingResult](docs/FleetNebiusAccountBindingResult.md)
 ...
 - [FleetUpdateConsumptionUserRequest](docs/FleetUpdateConsumptionUserRequest.md)
 - [FleetUpdateConsumptionUserRequest2](docs/FleetUpdateConsumptionUserRequest2.md)
 ...
 - [FleetUpdateResourceInstanceMetadataRequest](docs/FleetUpdateResourceInstanceMetadataRequest.md)
 - [FleetUpdateResourceInstanceMetadataRequest2](docs/FleetUpdateResourceInstanceMetadataRequest2.md)
 ...
 - [GenerateServicePlanSpecOrComposeSpecForOnboardingRequest](docs/GenerateServicePlanSpecOrComposeSpecForOnboardingRequest.md)
 - [GenerateServicePlanSpecOrComposeSpecForOnboardingResult](docs/GenerateServicePlanSpecOrComposeSpecForOnboardingResult.md)
 ...
 - [InstanceUpgradeHistory](docs/InstanceUpgradeHistory.md)
 - [IntegrationStatus](docs/IntegrationStatus.md)
 - [IntegrationsHealth](docs/IntegrationsHealth.md)
 - [IntermediaryAccountDetail](docs/IntermediaryAccountDetail.md)
 ...
 - [ListAllInstanceSnapshotsRequest](docs/ListAllInstanceSnapshotsRequest.md)
 ...
 - [ListAllSnapshotsInHostClusterRequest](docs/ListAllSnapshotsInHostClusterRequest.md)
 - [ListAllSnapshotsInHostClusterResult](docs/ListAllSnapshotsInHostClusterResult.md)
 ...
 - [ListInstanceUpgradeHistoryRequest](docs/ListInstanceUpgradeHistoryRequest.md)
 - [ListInstanceUpgradeHistoryResult](docs/ListInstanceUpgradeHistoryResult.md)
 ...
 - [ListMarketplaceChannelListingsRequest](docs/ListMarketplaceChannelListingsRequest.md)
 - [ListMarketplaceChannelListingsResult](docs/ListMarketplaceChannelListingsResult.md)
 - [ListMarketplaceChannelsRequest](docs/ListMarketplaceChannelsRequest.md)
 - [ListMarketplaceChannelsResult](docs/ListMarketplaceChannelsResult.md)
 - [ListMarketplaceContractsRequest](docs/ListMarketplaceContractsRequest.md)
 - [ListMarketplaceContractsResult](docs/ListMarketplaceContractsResult.md)
 - [ListMarketplaceDeliveriesRequest](docs/ListMarketplaceDeliveriesRequest.md)
 - [ListMarketplaceDeliveriesResult](docs/ListMarketplaceDeliveriesResult.md)
 ...
 - [MarketplaceChannelConfig](docs/MarketplaceChannelConfig.md)
 ...
 - [MarketplaceEvent](docs/MarketplaceEvent.md)
 ...
 - [OnboardingChartDependency](docs/OnboardingChartDependency.md)
 - [OnboardingCustomerVariable](docs/OnboardingCustomerVariable.md)
 - [OnboardingDeploymentConfig](docs/OnboardingDeploymentConfig.md)
 - [OnboardingEndpoint](docs/OnboardingEndpoint.md)
 - [OnboardingHelmChartConfiguration](docs/OnboardingHelmChartConfiguration.md)
 - [OnboardingHelmRuntimeConfiguration](docs/OnboardingHelmRuntimeConfiguration.md)
 - [OnboardingKustomizeConfiguration](docs/OnboardingKustomizeConfiguration.md)
 - [OnboardingOperatorCRDConfiguration](docs/OnboardingOperatorCRDConfiguration.md)
 - [OnboardingResource](docs/OnboardingResource.md)
 - [OnboardingResourceConfig](docs/OnboardingResourceConfig.md)
 - [OnboardingResourceInputVariable](docs/OnboardingResourceInputVariable.md)
 - [OnboardingResourceOutputVariable](docs/OnboardingResourceOutputVariable.md)
 - [OnboardingSecret](docs/OnboardingSecret.md)
 - [OnboardingServiceConfig](docs/OnboardingServiceConfig.md)
 ...
 - [RedeemHandoffRequest](docs/RedeemHandoffRequest.md)
 - [RedeemHandoffRequest2](docs/RedeemHandoffRequest2.md)
 - [RedeemHandoffResult](docs/RedeemHandoffResult.md)
 - [RedeliverMarketplaceDeliveryRequest](docs/RedeliverMarketplaceDeliveryRequest.md)
 - [RedeliverMarketplaceDeliveryRequest2](docs/RedeliverMarketplaceDeliveryRequest2.md)
 ...
 - [RestoreFromInstanceSnapshotRequest](docs/RestoreFromInstanceSnapshotRequest.md)
 ...
 - [RetryMarketplaceFulfillmentRequest](docs/RetryMarketplaceFulfillmentRequest.md)
 - [RetryMarketplaceFulfillmentRequest2](docs/RetryMarketplaceFulfillmentRequest2.md)
 ...
 - [RotateSandboxSecretRequest](docs/RotateSandboxSecretRequest.md)
 - [RotateSandboxSecretResult](docs/RotateSandboxSecretResult.md)
 ...
 - [SandboxCheck](docs/SandboxCheck.md)
 - [SandboxCheckoutRequest](docs/SandboxCheckoutRequest.md)
 ...
 - [SendSandboxEventRequest](docs/SendSandboxEventRequest.md)
 - [SendSandboxEventRequest2](docs/SendSandboxEventRequest2.md)
 ...
 - [SimulateContractEventRequest](docs/SimulateContractEventRequest.md)
 - [SimulateContractEventRequest2](docs/SimulateContractEventRequest2.md)
 - [SimulateContractEventResult](docs/SimulateContractEventResult.md)
 - [SlackConfiguration](docs/SlackConfiguration.md)
 - [SnapshotSearchRecord](docs/SnapshotSearchRecord.md)
 - [StartResourceInstanceRequest](docs/StartResourceInstanceRequest.md)
 - [StartSandboxRunRequest](docs/StartSandboxRunRequest.md)
 - [StartSandboxRunRequest2](docs/StartSandboxRunRequest2.md)
 ...
 - [UpdateDeploymentCellWorkflowRequest](docs/UpdateDeploymentCellWorkflowRequest.md)
 - [UpdateDeploymentCellWorkflowRequest2](docs/UpdateDeploymentCellWorkflowRequest2.md)
 ...
 - [UpdateMarketplaceChannelRequest](docs/UpdateMarketplaceChannelRequest.md)
 - [UpdateMarketplaceChannelRequest2](docs/UpdateMarketplaceChannelRequest2.md)
 ...
 - [UpdateResourceInstanceMetadataRequest](docs/UpdateResourceInstanceMetadataRequest.md)
 ...
 - [ValidateMarketplaceChannelRequest](docs/ValidateMarketplaceChannelRequest.md)
