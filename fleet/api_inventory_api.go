...
type InventoryApiAPI interface {
	...
	*/
	...
	/*
	InventoryApiApplyPendingChangesToHostCluster ApplyPendingChangesToHostCluster inventory-api

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param serviceId The service ID this workflow belongs to.
	@param environmentId The service environment ID this workflow belongs to.
	@param id The host cluster ID
	@return ApiInventoryApiApplyPendingChangesToHostClusterRequest
	*/
	InventoryApiApplyPendingChangesToHostCluster(ctx context.Context, serviceId string, environmentId string, id string) ApiInventoryApiApplyPendingChangesToHostClusterRequest

	// InventoryApiApplyPendingChangesToHostClusterExecute executes the request
	InventoryApiApplyPendingChangesToHostClusterExecute(r ApiInventoryApiApplyPendingChangesToHostClusterRequest) (*http.Response, error)
	...
	*/
	...
	/*
	InventoryApiUpdateHostCluster UpdateHostCluster inventory-api

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param serviceId The service ID this workflow belongs to.
	@param environmentId The service environment ID this workflow belongs to.
	@param id The host cluster ID
	@return ApiInventoryApiUpdateHostClusterRequest
	*/
	InventoryApiUpdateHostCluster(ctx context.Context, serviceId string, environmentId string, id string) ApiInventoryApiUpdateHostClusterRequest

	// InventoryApiUpdateHostClusterExecute executes the request
	InventoryApiUpdateHostClusterExecute(r ApiInventoryApiUpdateHostClusterRequest) (*http.Response, error)
...
type ApiInventoryApiApplyPendingChangesToHostClusterRequest struct {
	ctx context.Context
	ApiService InventoryApiAPI
	serviceId string
	environmentId string
...
func (r ApiInventoryApiApplyPendingChangesToHostClusterRequest) Execute() (*http.Response, error) {
	return r.ApiService.InventoryApiApplyPendingChangesToHostClusterExecute(r)
}
...
InventoryApiApplyPendingChangesToHostCluster ApplyPendingChangesToHostCluster inventory-api
 ...
 @return ApiInventoryApiApplyPendingChangesToHostClusterRequest
*/
func (a *InventoryApiAPIService) InventoryApiApplyPendingChangesToHostCluster(ctx context.Context, serviceId string, environmentId string, id string) ApiInventoryApiApplyPendingChangesToHostClusterRequest {
	return ApiInventoryApiApplyPendingChangesToHostClusterRequest{
		ApiService: a,
		ctx: ctx,
		serviceId: serviceId,
...
// Execute executes the request
func (a *InventoryApiAPIService) InventoryApiApplyPendingChangesToHostClusterExecute(r ApiInventoryApiApplyPendingChangesToHostClusterRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InventoryApiAPIService.InventoryApiApplyPendingChangesToHostCluster")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2022-09-01-00/fleet/service/{serviceId}/environment/{environmentId}/host-cluster/{id}/apply-pending-changes"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceId"+"}", url.PathEscape(parameterValueToString(r.serviceId, "serviceId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentId"+"}", url.PathEscape(parameterValueToString(r.environmentId, "environmentId")), -1)
...
type ApiInventoryApiUpdateHostClusterRequest struct {
	ctx context.Context
	ApiService InventoryApiAPI
	serviceId string
	environmentId string
	id string
	fleetUpdateHostClusterRequest2 *FleetUpdateHostClusterRequest2
}

func (r ApiInventoryApiUpdateHostClusterRequest) FleetUpdateHostClusterRequest2(fleetUpdateHostClusterRequest2 FleetUpdateHostClusterRequest2) ApiInventoryApiUpdateHostClusterRequest {
	r.fleetUpdateHostClusterRequest2 = &fleetUpdateHostClusterRequest2
	return r
}

func (r ApiInventoryApiUpdateHostClusterRequest) Execute() (*http.Response, error) {
	return r.ApiService.InventoryApiUpdateHostClusterExecute(r)
}
...
InventoryApiUpdateHostCluster UpdateHostCluster inventory-api
 ...
 @return ApiInventoryApiUpdateHostClusterRequest
*/
func (a *InventoryApiAPIService) InventoryApiUpdateHostCluster(ctx context.Context, serviceId string, environmentId string, id string) ApiInventoryApiUpdateHostClusterRequest {
	return ApiInventoryApiUpdateHostClusterRequest{
		ApiService: a,
		ctx: ctx,
		serviceId: serviceId,
...
// Execute executes the request
func (a *InventoryApiAPIService) InventoryApiUpdateHostClusterExecute(r ApiInventoryApiUpdateHostClusterRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InventoryApiAPIService.InventoryApiUpdateHostCluster")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.fleetUpdateHostClusterRequest2 == nil {
		return nil, reportError("fleetUpdateHostClusterRequest2 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.fleetUpdateHostClusterRequest2
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
