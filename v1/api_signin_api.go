...
type SigninApiAPI interface {
	...
	*/
	...
	/*
	SigninApiRefreshToken RefreshToken signin-api

	Exchange a valid refresh token for a new JWT token and refresh token pair

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiSigninApiRefreshTokenRequest
	*/
	SigninApiRefreshToken(ctx context.Context) ApiSigninApiRefreshTokenRequest

	// SigninApiRefreshTokenExecute executes the request
...
type ApiSigninApiRefreshTokenRequest struct {
	ctx context.Context
	ApiService SigninApiAPI
	refreshTokenRequest *RefreshTokenRequest
}

func (r ApiSigninApiRefreshTokenRequest) RefreshTokenRequest(refreshTokenRequest RefreshTokenRequest) ApiSigninApiRefreshTokenRequest {
	r.refreshTokenRequest = &refreshTokenRequest
	return r
}

func (r ApiSigninApiRefreshTokenRequest) Execute() (*RefreshTokenResult, *http.Response, error) {
	return r.ApiService.SigninApiRefreshTokenExecute(r)
}
...
Exchange a valid refresh token for a new JWT token and refresh token pair
 ...
 @return ApiSigninApiRefreshTokenRequest
*/
func (a *SigninApiAPIService) SigninApiRefreshToken(ctx context.Context) ApiSigninApiRefreshTokenRequest {
	return ApiSigninApiRefreshTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return RefreshTokenResult
func (a *SigninApiAPIService) SigninApiRefreshTokenExecute(r ApiSigninApiRefreshTokenRequest) (*RefreshTokenResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RefreshTokenResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SigninApiAPIService.SigninApiRefreshToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2022-09-01-00/refresh-token"
