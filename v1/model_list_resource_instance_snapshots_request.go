...
// checks if the ListResourceInstanceSnapshotsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResourceInstanceSnapshotsRequest{}

// ListResourceInstanceSnapshotsRequest struct for ListResourceInstanceSnapshotsRequest
type ListResourceInstanceSnapshotsRequest struct {
	// The instance ID
	Id string `json:"id"`
...
type _ListResourceInstanceSnapshotsRequest ListResourceInstanceSnapshotsRequest
...
func NewListResourceInstanceSnapshotsRequest(id string, productTierKey string, resourceKey string, serviceAPIVersion string, serviceEnvironmentKey string, serviceKey string, serviceModelKey string, serviceProviderId string, token string) *ListResourceInstanceSnapshotsRequest {
	this := ListResourceInstanceSnapshotsRequest{}
	this.Id = id
...
func (o ListResourceInstanceSnapshotsRequest) MarshalJSON() ([]byte, error) {
...
func (o ListResourceInstanceSnapshotsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ListResourceInstanceSnapshotsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varListResourceInstanceSnapshotsRequest := _ListResourceInstanceSnapshotsRequest{}

	err = json.Unmarshal(data, &varListResourceInstanceSnapshotsRequest)

	if err != nil {
		return err
	}

	*o = ListResourceInstanceSnapshotsRequest(varListResourceInstanceSnapshotsRequest)
...
type NullableListResourceInstanceSnapshotsRequest struct {
	value *ListResourceInstanceSnapshotsRequest
	isSet bool
}

func (v NullableListResourceInstanceSnapshotsRequest) Get() *ListResourceInstanceSnapshotsRequest {
	return v.value
}

func (v *NullableListResourceInstanceSnapshotsRequest) Set(val *ListResourceInstanceSnapshotsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableListResourceInstanceSnapshotsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableListResourceInstanceSnapshotsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResourceInstanceSnapshotsRequest(val *ListResourceInstanceSnapshotsRequest) *NullableListResourceInstanceSnapshotsRequest {
	return &NullableListResourceInstanceSnapshotsRequest{value: val, isSet: true}
}

func (v NullableListResourceInstanceSnapshotsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListResourceInstanceSnapshotsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
