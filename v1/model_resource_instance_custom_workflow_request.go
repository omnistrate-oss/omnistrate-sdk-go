...
// checks if the ResourceInstanceCustomWorkflowRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceInstanceCustomWorkflowRequest{}

// ResourceInstanceCustomWorkflowRequest struct for ResourceInstanceCustomWorkflowRequest
type ResourceInstanceCustomWorkflowRequest struct {
...
type _ResourceInstanceCustomWorkflowRequest ResourceInstanceCustomWorkflowRequest
...
func NewResourceInstanceCustomWorkflowRequest(id string, productTierKey string, resourceKey string, serviceAPIVersion string, serviceEnvironmentKey string, serviceKey string, serviceModelKey string, serviceProviderId string, token string, workflowId string) *ResourceInstanceCustomWorkflowRequest {
	this := ResourceInstanceCustomWorkflowRequest{}
	this.Id = id
...
func (o ResourceInstanceCustomWorkflowRequest) MarshalJSON() ([]byte, error) {
...
func (o ResourceInstanceCustomWorkflowRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceInstanceCustomWorkflowRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceInstanceCustomWorkflowRequest := _ResourceInstanceCustomWorkflowRequest{}

	err = json.Unmarshal(data, &varResourceInstanceCustomWorkflowRequest)

	if err != nil {
		return err
	}

	*o = ResourceInstanceCustomWorkflowRequest(varResourceInstanceCustomWorkflowRequest)
...
type NullableResourceInstanceCustomWorkflowRequest struct {
	value *ResourceInstanceCustomWorkflowRequest
	isSet bool
}

func (v NullableResourceInstanceCustomWorkflowRequest) Get() *ResourceInstanceCustomWorkflowRequest {
	return v.value
}

func (v *NullableResourceInstanceCustomWorkflowRequest) Set(val *ResourceInstanceCustomWorkflowRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceInstanceCustomWorkflowRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceInstanceCustomWorkflowRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceInstanceCustomWorkflowRequest(val *ResourceInstanceCustomWorkflowRequest) *NullableResourceInstanceCustomWorkflowRequest {
	return &NullableResourceInstanceCustomWorkflowRequest{value: val, isSet: true}
}

func (v NullableResourceInstanceCustomWorkflowRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceInstanceCustomWorkflowRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
