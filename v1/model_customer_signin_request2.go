...
// checks if the CustomerSigninRequest2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerSigninRequest2{}

// CustomerSigninRequest2 struct for CustomerSigninRequest2
type CustomerSigninRequest2 struct {
...
type _CustomerSigninRequest2 CustomerSigninRequest2
...
func (o CustomerSigninRequest2) MarshalJSON() ([]byte, error) {
...
func (o CustomerSigninRequest2) ToMap() (map[string]interface{}, error) {
...
func (o *CustomerSigninRequest2) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerSigninRequest2 := _CustomerSigninRequest2{}

	err = json.Unmarshal(data, &varCustomerSigninRequest2)

	if err != nil {
		return err
	}

	*o = CustomerSigninRequest2(varCustomerSigninRequest2)
...
type NullableCustomerSigninRequest2 struct {
	value *CustomerSigninRequest2
	isSet bool
}

func (v NullableCustomerSigninRequest2) Get() *CustomerSigninRequest2 {
	return v.value
}

func (v *NullableCustomerSigninRequest2) Set(val *CustomerSigninRequest2) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerSigninRequest2) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerSigninRequest2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerSigninRequest2(val *CustomerSigninRequest2) *NullableCustomerSigninRequest2 {
	return &NullableCustomerSigninRequest2{value: val, isSet: true}
}

func (v NullableCustomerSigninRequest2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerSigninRequest2) UnmarshalJSON(src []byte) error {
	v.isSet = true
