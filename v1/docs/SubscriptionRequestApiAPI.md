...
func main() {
	createSubscriptionRequestRequest2 := *openapiclient.NewCreateSubscriptionRequestRequest2("Voluptatem neque iste rem ex.", "s-123456") // CreateSubscriptionRequestRequest2 | 
