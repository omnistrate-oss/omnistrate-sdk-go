...
func main() {
	createSubscriptionRequestRequest2 := *openapiclient.NewCreateSubscriptionRequestRequest2("Laudantium quos facilis quam eos.", "s-123456") // CreateSubscriptionRequestRequest2 | 
