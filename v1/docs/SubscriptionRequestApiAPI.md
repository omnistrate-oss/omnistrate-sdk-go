...
func main() {
	createSubscriptionRequestRequest2 := *openapiclient.NewCreateSubscriptionRequestRequest2("Eius harum itaque ex ullam.", "s-123456") // CreateSubscriptionRequestRequest2 | 
