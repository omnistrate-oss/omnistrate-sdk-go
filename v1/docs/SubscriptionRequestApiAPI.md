...
func main() {
	createSubscriptionRequestRequest2 := *openapiclient.NewCreateSubscriptionRequestRequest2("Omnis culpa molestiae incidunt.", "s-123456") // CreateSubscriptionRequestRequest2 | 
