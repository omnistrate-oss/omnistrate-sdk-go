...
func main() {
	serviceId := "s-12345678" // string | The service ID that this API bundle belongs to
	createResourceRequest2 := *openapiclient.NewCreateResourceRequest2("A resource to manage a hosted public SaaS offering of a multi-writer MySQL service", "Galera", "Nesciunt error.") // CreateResourceRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | The service ID that this API bundle belongs to
	id := "r-12345678" // string | The ID of the resource
	productTierVersion := "Aut sint veritatis voluptatibus." // string | Product tier version of the resource to describe. If not specified, the latest version is described. (optional)
...
func main() {
	serviceId := "s-12345678" // string | The service ID that this API bundle belongs to
	id := "r-12345678" // string | The ID of the resource
	productTierVersion := "Animi cupiditate corporis nihil sunt officia." // string | Product tier version of the resource to describe. If not specified, the latest version is described. (optional)
	productTierId := "Ad a officiis est nobis debitis eos." // string | ProductTierId of the resource to describe. Needs to specified in combination with the product tier version (optional)
...
func main() {
	serviceId := "s-12345678" // string | The service ID that this API bundle belongs to
	id := "r-12345678" // string | The ID of the resource
	productTierVersion := "Ipsam nam voluptatem minus facilis." // string | Product tier version of the instance to describe. If not specified, the latest version is described. (optional)
...
func main() {
	...
	productTierVersion := "Dolor possimus." // string | Product tier version of the instance to describe. If not specified, the latest version is described. (optional)
