...
func main() {
	createAccountConfigRequest2 := *openapiclient.NewCreateAccountConfigRequest2("Qui nam.", "An AWS account hosting multiple dev environments", "Dev AWS account") // CreateAccountConfigRequest2 | 
