...
func main() {
	serviceId := "s-12345678" // string | The service ID
	id := "sc-12345678" // string | The storage config ID
	productTierVersion := "Nemo eum expedita qui iure occaecati qui." // string | Product tier version of the storage config to describe. If not specified, the latest version is described. (optional)
