...
func main() {
	...
	createServiceEnvironmentRequest2 := *openapiclient.NewCreateServiceEnvironmentRequest2("Quos ab sequi ea.", "The production environment for the MySQL multi-writer service", "Production") // CreateServiceEnvironmentRequest2 | 
