...
func main() {
	...
	createServiceEnvironmentRequest2 := *openapiclient.NewCreateServiceEnvironmentRequest2("Harum ducimus cupiditate.", "The production environment for the MySQL multi-writer service", "Production") // CreateServiceEnvironmentRequest2 | 
