...
func main() {
	uploadDeploymentArtifactRequest2 := *openapiclient.NewUploadDeploymentArtifactRequest2("ac-1234567890", "/path/to", "Repellat autem quae nulla omnis consequatur.", "standard", "my-service") // UploadDeploymentArtifactRequest2 | 
