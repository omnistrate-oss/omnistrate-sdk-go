...
func main() {
	uploadDeploymentArtifactRequest2 := *openapiclient.NewUploadDeploymentArtifactRequest2("ac-1234567890", "/path/to", "Aut rerum consequuntur provident et qui.", "PROD|PRIVATE|CANARY|STAGING|QA|DEV|GLOBAL", "standard", "my-service") // UploadDeploymentArtifactRequest2 | 
