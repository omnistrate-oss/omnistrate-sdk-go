...
[**DeploymentArtifactApiDownloadDeploymentArtifact**](DeploymentArtifactApiAPI.md#DeploymentArtifactApiDownloadDeploymentArtifact) | **Get** /2022-09-01-00/deployment-artifact/{id}/download | DownloadDeploymentArtifact deployment-artifact-api
...
## DeploymentArtifactApiDownloadDeploymentArtifact

> *os.File DeploymentArtifactApiDownloadDeploymentArtifact(ctx, id).Hash(hash).Execute()

DownloadDeploymentArtifact deployment-artifact-api
...
func main() {
	id := "da-12345678" // string | The ID of the deployment artifact
	hash := "3a7bd3e2360a3d4855f3c8d2f8f6e6c1" // string | Hash of the deployment artifact to download. If not specified, the latest version is downloaded. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DeploymentArtifactApiAPI.DeploymentArtifactApiDownloadDeploymentArtifact(context.Background(), id).Hash(hash).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `DeploymentArtifactApiAPI.DeploymentArtifactApiDownloadDeploymentArtifact``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `DeploymentArtifactApiDownloadDeploymentArtifact`: *os.File
	fmt.Fprintf(os.Stdout, "Response from `DeploymentArtifactApiAPI.DeploymentArtifactApiDownloadDeploymentArtifact`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDeploymentArtifactApiDownloadDeploymentArtifactRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **hash** | **string** | Hash of the deployment artifact to download. If not specified, the latest version is downloaded. | 
...
func main() {
	uploadDeploymentArtifactRequest2 := *openapiclient.NewUploadDeploymentArtifactRequest2("ac-1234567890", "/path/to", "Hic et officiis suscipit.", "PROD|PRIVATE|CANARY|STAGING|QA|DEV|GLOBAL", "standard", "my-service") // UploadDeploymentArtifactRequest2 | 
