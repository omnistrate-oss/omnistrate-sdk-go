...
func main() {
	buildServiceFromComposeSpecRequest2 := *openapiclient.NewBuildServiceFromComposeSpecRequest2("Natus cumque delectus beatae explicabo.", "MySQL multi-writer service") // BuildServiceFromComposeSpecRequest2 | 
...
func main() {
	buildServiceFromServicePlanSpecRequest2 := *openapiclient.NewBuildServiceFromServicePlanSpecRequest2("Deserunt id corrupti.", "MySQL multi-writer service") // BuildServiceFromServicePlanSpecRequest2 | 
...
func main() {
	createServiceFromComposeSpecRequest2 := *openapiclient.NewCreateServiceFromComposeSpecRequest2("A MySQL SaaS specializing in multi-writer clusters for high availability", "Qui ducimus qui est assumenda officiis.", "text/plain", "mysql.yaml", "MySQL multi-writer service") // CreateServiceFromComposeSpecRequest2 | 
...
func main() {
	prepareServiceFromServicePlanSpecRequest2 := *openapiclient.NewPrepareServiceFromServicePlanSpecRequest2("dev", "PROD|PRIVATE|CANARY|STAGING|QA|DEV|GLOBAL", "Suscipit ut sunt tempore omnis eius tenetur.", "MySQL multi-writer service") // PrepareServiceFromServicePlanSpecRequest2 | 
