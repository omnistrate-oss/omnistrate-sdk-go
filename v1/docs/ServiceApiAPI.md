...
func main() {
	buildServiceFromComposeSpecRequest2 := *openapiclient.NewBuildServiceFromComposeSpecRequest2("Neque aliquid id maiores.", "MySQL multi-writer service") // BuildServiceFromComposeSpecRequest2 | 
...
func main() {
	buildServiceFromServicePlanSpecRequest2 := *openapiclient.NewBuildServiceFromServicePlanSpecRequest2("Architecto saepe et veniam dolores rerum.", "MySQL multi-writer service") // BuildServiceFromServicePlanSpecRequest2 | 
...
func main() {
	createServiceFromComposeSpecRequest2 := *openapiclient.NewCreateServiceFromComposeSpecRequest2("A MySQL SaaS specializing in multi-writer clusters for high availability", "Omnis in officia.", "text/plain", "mysql.yaml", "MySQL multi-writer service") // CreateServiceFromComposeSpecRequest2 | 
...
func main() {
	prepareServiceFromServicePlanSpecRequest2 := *openapiclient.NewPrepareServiceFromServicePlanSpecRequest2("dev", "PROD|PRIVATE|CANARY|STAGING|QA|DEV|GLOBAL", "Voluptate dolores qui hic.", "MySQL multi-writer service") // PrepareServiceFromServicePlanSpecRequest2 | 
