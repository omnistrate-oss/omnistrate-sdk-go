...
func main() {
	serviceId := "s-12345678" // string | The ID of the service
	id := "nc-12345678" // string | The ID of the network config
	productTierVersion := "Dolorem quaerat enim." // string | Product tier version of the network config to describe. If not specified, the latest version is described. (optional)
