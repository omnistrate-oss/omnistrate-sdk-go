...
func main() {
	serviceId := "s-12345678" // string | The service ID this model belongs to
	id := "sm-12345678" // string | The service model ID
	disableServiceModelFeatureRequest2 := *openapiclient.NewDisableServiceModelFeatureRequest2("In quaerat eos dicta nulla optio.") // DisableServiceModelFeatureRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | The service ID this model belongs to
	id := "sm-12345678" // string | The service model ID
	enableServiceModelFeatureRequest2 := *openapiclient.NewEnableServiceModelFeatureRequest2(map[string]interface{}{"key": interface{}(123)}, "Cupiditate tempora quisquam voluptatem officia est.") // EnableServiceModelFeatureRequest2 | 
