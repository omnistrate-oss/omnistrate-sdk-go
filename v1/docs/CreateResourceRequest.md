...
`func (o *CreateResourceRequest) GetDeploymentTarget() DeploymentTarget`

GetDeploymentTarget returns the DeploymentTarget field if non-nil, zero value otherwise.

### GetDeploymentTargetOk

`func (o *CreateResourceRequest) GetDeploymentTargetOk() (*DeploymentTarget, bool)`
...
`func (o *CreateResourceRequest) SetDeploymentTarget(v DeploymentTarget)`

SetDeploymentTarget sets DeploymentTarget field to given value.

### HasDeploymentTarget

`func (o *CreateResourceRequest) HasDeploymentTarget() bool`
