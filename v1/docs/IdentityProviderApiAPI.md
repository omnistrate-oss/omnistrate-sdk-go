...
func main() {
	createIdentityProviderRequest2 := *openapiclient.NewCreateIdentityProviderRequest2("exampleclientid.apps.googleusercontent.com", "exampleclientsecret", "Google|GitHub|Microsoft Entra|Amazon Cognito|Okta|Auth0|Keycloak|OIDC") // CreateIdentityProviderRequest2 | 
