...
func main() {
	...
	createInputParameterRequest2 := *openapiclient.NewCreateInputParameterRequest2("Aut iusto voluptatem ipsa aperiam.", "np", true, "2h", true, "Deserunt amet dolorem quo aperiam.", "Boolean|Float64|String|Resource|Secret|Password") // CreateInputParameterRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | The ID of the service that this output parameter belongs to
	id := "var-12345678" // string | ID of the input parameter
	productTierVersion := "Vitae occaecati in odio voluptatem veritatis alias." // string | Product tier version of the instance to describe. If not specified, the latest version is described. (optional)
...
func main() {
	...
	productTierVersion := "Assumenda sit quia harum voluptas." // string | Product tier version of the instance to describe. If not specified, the latest version is described. (optional)
	productTierId := "Qui consequatur a voluptatem." // string | Product tier id of the instance to describe. Needs to specified in combination with the product tier version (optional)
