...
`func (o *UpdateProductTierRequest) GetByocOnpremRegions() []string`

GetByocOnpremRegions returns the ByocOnpremRegions field if non-nil, zero value otherwise.

### GetByocOnpremRegionsOk

`func (o *UpdateProductTierRequest) GetByocOnpremRegionsOk() (*[]string, bool)`
...
`func (o *UpdateProductTierRequest) SetByocOnpremRegions(v []string)`

SetByocOnpremRegions sets ByocOnpremRegions field to given value.

### HasByocOnpremRegions

`func (o *UpdateProductTierRequest) HasByocOnpremRegions() bool`
...
`func (o *UpdateProductTierRequest) HasNebiusRegions() bool`
