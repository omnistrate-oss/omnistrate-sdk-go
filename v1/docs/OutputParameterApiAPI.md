...
func main() {
	...
	createOutputParameterRequest2 := *openapiclient.NewCreateOutputParameterRequest2("Username of the user created in the target system", "username", "Username", "Nihil et quis est.") // CreateOutputParameterRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | The ID of the service that this output parameter belongs to
	id := "op-12345678" // string | The ID of the output parameter
	productTierVersion := "Inventore et consectetur." // string | Product tier version of the resource to describe. If not specified, the latest version is described. (optional)
...
func main() {
	...
	productTierVersion := "Explicabo a expedita nesciunt libero est aut." // string | Product tier version of the resource to describe. If not specified, the latest version is described. (optional)
	productTierId := "Sapiente ut dolores quo laudantium." // string | ProductTierId of the resource to describe. Needs to specified in combination with the product tier version (optional)
