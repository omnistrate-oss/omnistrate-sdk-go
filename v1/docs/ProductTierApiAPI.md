...
func main() {
	...
	copyProductTierRequest2 := *openapiclient.NewCopyProductTierRequest2("A premium product tier", "Premium", "Minima corrupti.") // CopyProductTierRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | Service ID
	createProductTierRequest2 := *openapiclient.NewCreateProductTierRequest2("A premium product tier", "Premium", "A premium plan", "Molestiae quia ea fugit impedit nulla temporibus.", "OMNISTRATE_DEDICATED_TENANCY|OMNISTRATE_MULTI_TENANCY|CUSTOM_TENANCY") // CreateProductTierRequest2 | 
