...
func main() {
	...
	copyProductTierRequest2 := *openapiclient.NewCopyProductTierRequest2("A premium product tier", "Premium", "Magnam facere enim pariatur maxime.") // CopyProductTierRequest2 | 
...
func main() {
	serviceId := "s-12345678" // string | Service ID
	createProductTierRequest2 := *openapiclient.NewCreateProductTierRequest2("A premium product tier", "Premium", "A premium plan", "Est culpa libero pariatur excepturi nulla.", "OMNISTRATE_DEDICATED_TENANCY|OMNISTRATE_MULTI_TENANCY|CUSTOM_TENANCY") // CreateProductTierRequest2 | 
