...
func main() {
	serviceId := "s-12345678" // string | The ID of the service that this workflow belongs to
	id := "cwt-12345678" // string | The custom workflow ID
	productTierVersion := "Dolores est aut id necessitatibus nisi." // string | Product tier version of the workflow to describe. If not specified, the latest version is described. (optional)
...
func main() {
	...
	productTierVersion := "Et molestiae aperiam deleniti." // string | Product tier version of the workflows to describe. If not specified, the latest version is described. (optional)
