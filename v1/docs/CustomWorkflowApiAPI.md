...
func main() {
	serviceId := "s-12345678" // string | The ID of the service that this workflow belongs to
	id := "cwt-12345678" // string | The custom workflow ID
	productTierVersion := "Neque aperiam libero quas tempore doloremque ut." // string | Product tier version of the workflow to describe. If not specified, the latest version is described. (optional)
...
func main() {
	...
	productTierVersion := "Quo explicabo quis ad qui rerum ut." // string | Product tier version of the workflows to describe. If not specified, the latest version is described. (optional)
