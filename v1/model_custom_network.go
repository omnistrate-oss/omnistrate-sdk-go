...
// SetNetworkInstances gets a reference to the given []CustomNetworkInstance and assigns it to the NetworkInstances field.
...
func (o *CustomNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCustomNetwork)
