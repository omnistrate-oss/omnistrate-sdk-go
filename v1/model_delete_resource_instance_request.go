...
// checks if the DeleteResourceInstanceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteResourceInstanceRequest{}

// DeleteResourceInstanceRequest struct for DeleteResourceInstanceRequest
...
type _DeleteResourceInstanceRequest DeleteResourceInstanceRequest
...
func (o DeleteResourceInstanceRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteResourceInstanceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteResourceInstanceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteResourceInstanceRequest := _DeleteResourceInstanceRequest{}

	err = json.Unmarshal(data, &varDeleteResourceInstanceRequest)

	if err != nil {
		return err
	}

	*o = DeleteResourceInstanceRequest(varDeleteResourceInstanceRequest)
...
type NullableDeleteResourceInstanceRequest struct {
	value *DeleteResourceInstanceRequest
	isSet bool
}

func (v NullableDeleteResourceInstanceRequest) Get() *DeleteResourceInstanceRequest {
	return v.value
}

func (v *NullableDeleteResourceInstanceRequest) Set(val *DeleteResourceInstanceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteResourceInstanceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteResourceInstanceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteResourceInstanceRequest(val *DeleteResourceInstanceRequest) *NullableDeleteResourceInstanceRequest {
	return &NullableDeleteResourceInstanceRequest{value: val, isSet: true}
}

func (v NullableDeleteResourceInstanceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteResourceInstanceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
