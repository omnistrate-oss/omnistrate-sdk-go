...
type ResourceApiAPI interface {
	...
	*/
	...
	/*
	ResourceApiUndeprecateResource UndeprecateResource resource-api

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param serviceId The service ID that this API bundle belongs to
	@param id The ID of the resource
	@return ApiResourceApiUndeprecateResourceRequest
	*/
	ResourceApiUndeprecateResource(ctx context.Context, serviceId string, id string) ApiResourceApiUndeprecateResourceRequest

	// ResourceApiUndeprecateResourceExecute executes the request
	ResourceApiUndeprecateResourceExecute(r ApiResourceApiUndeprecateResourceRequest) (*http.Response, error)
...
type ApiResourceApiUndeprecateResourceRequest struct {
	ctx context.Context
	ApiService ResourceApiAPI
	serviceId string
	id string
...
func (r ApiResourceApiUndeprecateResourceRequest) Execute() (*http.Response, error) {
	return r.ApiService.ResourceApiUndeprecateResourceExecute(r)
}
...
ResourceApiUndeprecateResource UndeprecateResource resource-api
 ...
 @return ApiResourceApiUndeprecateResourceRequest
*/
func (a *ResourceApiAPIService) ResourceApiUndeprecateResource(ctx context.Context, serviceId string, id string) ApiResourceApiUndeprecateResourceRequest {
	return ApiResourceApiUndeprecateResourceRequest{
		ApiService: a,
		ctx: ctx,
		serviceId: serviceId,
...
// Execute executes the request
func (a *ResourceApiAPIService) ResourceApiUndeprecateResourceExecute(r ApiResourceApiUndeprecateResourceRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResourceApiAPIService.ResourceApiUndeprecateResource")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2022-09-01-00/service/{serviceId}/resource/{id}/undeprecate"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceId"+"}", url.PathEscape(parameterValueToString(r.serviceId, "serviceId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
