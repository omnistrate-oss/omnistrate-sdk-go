...
// checks if the CreateNetworkConfigRequest2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkConfigRequest2{}

// CreateNetworkConfigRequest2 struct for CreateNetworkConfigRequest2
type CreateNetworkConfigRequest2 struct {
...
type _CreateNetworkConfigRequest2 CreateNetworkConfigRequest2
...
func NewCreateNetworkConfigRequest2(description string, endpointPerReplica bool, name string) *CreateNetworkConfigRequest2 {
	this := CreateNetworkConfigRequest2{}
...
func (o CreateNetworkConfigRequest2) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkConfigRequest2) ToMap() (map[string]interface{}, error) {
...
func (o *CreateNetworkConfigRequest2) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNetworkConfigRequest2 := _CreateNetworkConfigRequest2{}

	err = json.Unmarshal(data, &varCreateNetworkConfigRequest2)

	if err != nil {
		return err
	}

	*o = CreateNetworkConfigRequest2(varCreateNetworkConfigRequest2)
...
type NullableCreateNetworkConfigRequest2 struct {
	value *CreateNetworkConfigRequest2
	isSet bool
}

func (v NullableCreateNetworkConfigRequest2) Get() *CreateNetworkConfigRequest2 {
	return v.value
}

func (v *NullableCreateNetworkConfigRequest2) Set(val *CreateNetworkConfigRequest2) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkConfigRequest2) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkConfigRequest2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkConfigRequest2(val *CreateNetworkConfigRequest2) *NullableCreateNetworkConfigRequest2 {
	return &NullableCreateNetworkConfigRequest2{value: val, isSet: true}
}

func (v NullableCreateNetworkConfigRequest2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkConfigRequest2) UnmarshalJSON(src []byte) error {
	v.isSet = true
