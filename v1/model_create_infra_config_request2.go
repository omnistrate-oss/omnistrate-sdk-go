...
// checks if the CreateInfraConfigRequest2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateInfraConfigRequest2{}

// CreateInfraConfigRequest2 struct for CreateInfraConfigRequest2
type CreateInfraConfigRequest2 struct {
...
type _CreateInfraConfigRequest2 CreateInfraConfigRequest2
...
func NewCreateInfraConfigRequest2(description string, name string, serviceEnvironmentId string) *CreateInfraConfigRequest2 {
	this := CreateInfraConfigRequest2{}
...
func (o CreateInfraConfigRequest2) MarshalJSON() ([]byte, error) {
...
func (o CreateInfraConfigRequest2) ToMap() (map[string]interface{}, error) {
...
func (o *CreateInfraConfigRequest2) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateInfraConfigRequest2 := _CreateInfraConfigRequest2{}

	err = json.Unmarshal(data, &varCreateInfraConfigRequest2)

	if err != nil {
		return err
	}

	*o = CreateInfraConfigRequest2(varCreateInfraConfigRequest2)
...
type NullableCreateInfraConfigRequest2 struct {
	value *CreateInfraConfigRequest2
	isSet bool
}

func (v NullableCreateInfraConfigRequest2) Get() *CreateInfraConfigRequest2 {
	return v.value
}

func (v *NullableCreateInfraConfigRequest2) Set(val *CreateInfraConfigRequest2) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateInfraConfigRequest2) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateInfraConfigRequest2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateInfraConfigRequest2(val *CreateInfraConfigRequest2) *NullableCreateInfraConfigRequest2 {
	return &NullableCreateInfraConfigRequest2{value: val, isSet: true}
}

func (v NullableCreateInfraConfigRequest2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateInfraConfigRequest2) UnmarshalJSON(src []byte) error {
	v.isSet = true
