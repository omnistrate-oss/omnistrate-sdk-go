...
type UsageApiAPI interface {
	...
	*/
	...
	UsageApiGetCurrentUsageExecute(r ApiUsageApiGetCurrentUsageRequest) (*GetUsageResult, *http.Response, error)
	...
	*/
	...
	//  @return GetUsageResult
	UsageApiGetUsagePerDayExecute(r ApiUsageApiGetUsagePerDayRequest) (*GetUsageResult, *http.Response, error)
}
...
func (r ApiUsageApiGetCurrentUsageRequest) Execute() (*GetUsageResult, *http.Response, error) {
...
//  @return GetUsageResult
func (a *UsageApiAPIService) UsageApiGetCurrentUsageExecute(r ApiUsageApiGetCurrentUsageRequest) (*GetUsageResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetUsageResult
	)
...
func (r ApiUsageApiGetUsagePerDayRequest) Execute() (*GetUsageResult, *http.Response, error) {
...
// Execute executes the request
//  @return GetUsageResult
func (a *UsageApiAPIService) UsageApiGetUsagePerDayExecute(r ApiUsageApiGetUsagePerDayRequest) (*GetUsageResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/2022-09-01-00/usage-per-day"
