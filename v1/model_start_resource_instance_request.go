...
// checks if the StartResourceInstanceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StartResourceInstanceRequest{}

// StartResourceInstanceRequest struct for StartResourceInstanceRequest
type StartResourceInstanceRequest struct {
	// The instance ID
	Id string `json:"id"`
...
type _StartResourceInstanceRequest StartResourceInstanceRequest
...
func NewStartResourceInstanceRequest(id string, productTierKey string, resourceKey string, serviceAPIVersion string, serviceEnvironmentKey string, serviceKey string, serviceModelKey string, serviceProviderId string, token string) *StartResourceInstanceRequest {
	this := StartResourceInstanceRequest{}
	this.Id = id
...
func (o StartResourceInstanceRequest) MarshalJSON() ([]byte, error) {
...
func (o StartResourceInstanceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *StartResourceInstanceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varStartResourceInstanceRequest := _StartResourceInstanceRequest{}

	err = json.Unmarshal(data, &varStartResourceInstanceRequest)

	if err != nil {
		return err
	}

	*o = StartResourceInstanceRequest(varStartResourceInstanceRequest)
...
type NullableStartResourceInstanceRequest struct {
	value *StartResourceInstanceRequest
	isSet bool
}

func (v NullableStartResourceInstanceRequest) Get() *StartResourceInstanceRequest {
	return v.value
}

func (v *NullableStartResourceInstanceRequest) Set(val *StartResourceInstanceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStartResourceInstanceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStartResourceInstanceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStartResourceInstanceRequest(val *StartResourceInstanceRequest) *NullableStartResourceInstanceRequest {
	return &NullableStartResourceInstanceRequest{value: val, isSet: true}
}

func (v NullableStartResourceInstanceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStartResourceInstanceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
