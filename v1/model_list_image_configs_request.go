...
// checks if the ListImageConfigsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListImageConfigsRequest{}

// ListImageConfigsRequest struct for ListImageConfigsRequest
type ListImageConfigsRequest struct {
...
type _ListImageConfigsRequest ListImageConfigsRequest
...
func (o ListImageConfigsRequest) MarshalJSON() ([]byte, error) {
...
func (o ListImageConfigsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ListImageConfigsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varListImageConfigsRequest := _ListImageConfigsRequest{}

	err = json.Unmarshal(data, &varListImageConfigsRequest)

	if err != nil {
		return err
	}

	*o = ListImageConfigsRequest(varListImageConfigsRequest)
...
type NullableListImageConfigsRequest struct {
	value *ListImageConfigsRequest
	isSet bool
}

func (v NullableListImageConfigsRequest) Get() *ListImageConfigsRequest {
	return v.value
}

func (v *NullableListImageConfigsRequest) Set(val *ListImageConfigsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableListImageConfigsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableListImageConfigsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListImageConfigsRequest(val *ListImageConfigsRequest) *NullableListImageConfigsRequest {
	return &NullableListImageConfigsRequest{value: val, isSet: true}
}

func (v NullableListImageConfigsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListImageConfigsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
