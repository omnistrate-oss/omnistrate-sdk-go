...
func Test_v1_ServicesOrchestrationApiAPIService(t *testing.T) {
	...
	t.Run("Test ServicesOrchestrationApiAPIService ServicesOrchestrationApiListServicesOrchestrations", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.ServicesOrchestrationApiAPI.ServicesOrchestrationApiListServicesOrchestrations(context.Background()).Execute()
	...
	t.Run("Test ServicesOrchestrationApiAPIService ServicesOrchestrationApiModifyServicesOrchestration", func(t *testing.T) {
		...
		httpRes, err := apiClient.ServicesOrchestrationApiAPI.ServicesOrchestrationApiModifyServicesOrchestration(context.Background(), id).Execute()
