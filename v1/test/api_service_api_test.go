...
func Test_v1_ServiceApiAPIService(t *testing.T) {
	...
	t.Run("Test ServiceApiAPIService ServiceApiPrepareServiceFromServicePlanSpec", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.ServiceApiAPI.ServiceApiPrepareServiceFromServicePlanSpec(context.Background()).Execute()
